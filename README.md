...
<p align="center">
  ...
  <a href="mailto:pedrolucasfonseca98@gmail.com">
...
### [Ingressar](https://github.com/pedrolucasfonseca/Ingressar)
...
Ticketing platform with JWT authentication, refresh tokens, role-based access
control, Stripe integration and automated unit, integration and end-to-end tests.
...
### [Homelab](https://github.com/pedrolucasfonseca/Homelab)

![Node.js](https://img.shields.io/badge/Node.js-5FA04E?style=flat-square&logo=nodedotjs&logoColor=white)
![Docker](https://img.shields.io/badge/Docker-2496ED?style=flat-square&logo=docker&logoColor=white)
![Kubernetes](https://img.shields.io/badge/Kubernetes-326CE5?style=flat-square&logo=kubernetes&logoColor=white)
![Ansible](https://img.shields.io/badge/Ansible-EE0000?style=flat-square&logo=ansible&logoColor=white)
![Woodpecker CI](https://img.shields.io/badge/Woodpecker_CI-000000?style=flat-square)

Self-hosted environment for deploying backend services with a k3s cluster,
Ansible provisioning, Gitea, Woodpecker CI, private registry and automated
lint, test, build, validation and deployment stages.

### [DashLab](https://github.com/pedrolucasfonseca/Dashlab)
...
Infrastructure and observability lab with Terraform-defined AWS resources,
Kubernetes manifests, GitHub Actions CI/CD with OIDC and metrics, logs and
tracing through Prometheus, Grafana and OpenTelemetry.
